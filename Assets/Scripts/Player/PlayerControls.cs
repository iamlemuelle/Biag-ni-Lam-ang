...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_ChangeSkin.enabled, "This will cause a leak and performance issues, PlayerControls.ChangeSkin.Disable() has not been called.");
    }
    ...
    private List<IChangeSkinActions> m_ChangeSkinActionsCallbackInterfaces = new List<IChangeSkinActions>();
    ...
    public struct ChangeSkinActions
    {
        ...
        public void AddCallbacks(IChangeSkinActions instance)
        {
            if (instance == null || m_Wrapper.m_ChangeSkinActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ChangeSkinActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IChangeSkinActions instance)
        {
            @ChangeSkin.started -= instance.OnChangeSkin;
            @ChangeSkin.performed -= instance.OnChangeSkin;
            @ChangeSkin.canceled -= instance.OnChangeSkin;
        ...
        public void RemoveCallbacks(IChangeSkinActions instance)
        {
            if (m_Wrapper.m_ChangeSkinActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IChangeSkinActions instance)
        {
            foreach (var item in m_Wrapper.m_ChangeSkinActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ChangeSkinActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
